...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},I am {}, A latest advanced filestore bot with└ᴄʟᴏɴᴇ ғᴇᴀᴛᴜʀᴇ┘+└sᴛʀᴇᴀᴍ / ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ ғᴇᴀᴛᴜʀᴇ┘+├ᴄᴜꜱᴛᴏᴍ ᴜʀʟ ꜱʜᴏʀᴛɴᴇʀ ꜱᴜᴘᴘᴏʀᴛ┤+  ᢵᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ sᴜᴘᴘᴏʀᴛ ᢴ with best UI support</b>"""
...
# Ask Doubt on telegram @KingVJ01
    ...
    CAPTION = """<b>⚜️ POWERED BY: @DH_Networks ⚜️
📂 ғɪʟᴇɴᴀᴍᴇ : {file_name}

sɪᴢᴇ ⚙️: {file_size}

💢 Jᴏɪɴ Updates @sablinkhere </b>""" 
...
ɪғ ʏᴏᴜ ᴡᴀɴᴛ ᴛʜɪs ғᴇᴀᴛᴜʀᴇ ᴛʜᴇɴ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄʟᴏɴᴇ ʙᴏᴛ ғʀᴏᴍ ᴍʏ <a href=https://t.me/sablinkhere>ᴘᴀʀᴇɴᴛ</a></b>"""
...
🧑🏻‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ: <a href=https://t.me/dh_networks>DH Networks</a>

👥 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ: <a href=https://t.me/>Direct Hub Networks</a>

📢 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ: <a href=https://t.me/sablinkhere>All media Updates</a></b>
"""
...
ᴇx - /batch https://t.me/Latest_movies/25 https://t.me/Latest_movies/30
