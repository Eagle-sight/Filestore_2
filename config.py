...
ADMINS = int(environ.get("ADMINS", "7126250699"))
...
PICS = (environ.get('PICS', 'https://graph.org/file/06565c0cdbea661a2f51a.jpg https://graph.org/file/82ef767ffebe3a948e476.jpg')).split() # Bot Start Picture
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002185431065"))
...
class Var(object):
    ...
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002157768198'))
    ...
    if HAS_SSL:
        URL = "spontaneous-kimberley-technicaltests-06fccbdd.koyeb.app/"
    else:
        URL = "spontaneous-kimberley-technicaltests-06fccbdd.koyeb.app/"
